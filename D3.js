...
console.log("starWarsCharacters dopo cambio gender:", starWarsCharacters);
...
console.log("charactersNames rimasti:", charactersNames);
...
console.log("Il personaggio casuale è: " + randomCharacter.name);
